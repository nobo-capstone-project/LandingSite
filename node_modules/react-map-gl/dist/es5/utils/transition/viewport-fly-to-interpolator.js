...
function (_TransitionInterpolat) {
  ...
  function ViewportFlyToInterpolator() {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "propNames", VIEWPORT_TRANSITION_PROPS);
    return _this;
  }
  ...
  (0, _createClass2.default)(ViewportFlyToInterpolator, [{
    ...
    value: function initializeProps(startProps, endProps) {
      ...
      for (var _i2 = 0; _i2 < LINEARLY_INTERPOLATED_PROPS.length; _i2++) {
        var _key2 = LINEARLY_INTERPOLATED_PROPS[_i2];
